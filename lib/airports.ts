...
export const airports: Airport[] = [
  ...
  { iata: 'MJT', name: 'Mytilene', city: 'Lesbos', country: 'GR' },
  ...
  { iata: 'BSL', name: 'Euro Airport', city: 'Basel', country: 'CH' },
  { iata: 'OTP', name: 'Henri Coanda', city: 'Bucharest', country: 'RO' },
  ...
  { iata: 'REK', name: 'Keflavik', city: 'Reykjavik', country: 'IS' },
]
